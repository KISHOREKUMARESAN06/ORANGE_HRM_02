...
class Admin_page:
    ...
    def click_admin_module(self):
        admin = WebDriverWait(self.driver, 15).until(EC.presence_of_element_located(By.XPATH, Locators.admin_module_xpath))
        admin.click()
    ...
    def validate_headers(self):
        ...
        valid_header = WebDriverWait(self.driver, 20).until(EC.visibility_of_all_elements_located(By.XPATH, "//div[contains(@class, 'oxd-topbar-body')]"))
...
#------------------------------
    ...
    def validate_side_menu(self):
        ...
        valid_side_menu = WebDriverWait(self.driver, 20).until(EC.visibility_of_all_elements_located(By.XPATH, "//div[contains(@class, 'oxd-topbar-body')]"))
